...
function newtab() {
  ...
  browserview.webContents.on('did-finish-load', () => {
    ...
    win.webContents.executeJavaScript(
      `document.getElementsByTagName('title')[0].innerText='${browserview.webContents.getTitle()} - DREAM-BROWSER';
  ...
  browserview.webContents.on('page-title-updated', (e, t) => {
    win.webContents.executeJavaScript(
      `document.getElementsByTagName('title')[0].innerText='${t} - DREAM-BROWSER';
...
ipcMain.on('tabMove', (e, i) => {
  ...
  win.webContents.executeJavaScript(`
     ...
     document.getElementsByTagName('title')[0].innerText='${bv[
       index
     ].webContents.getTitle()} - DREAM-BROWSER';
     `)
})
...
Copyright 2021 vcborn.`,
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        label: t['DREAM-BROWSER_dev_tools'],
        accelerator: 'Alt+F12',
        click: () => {
